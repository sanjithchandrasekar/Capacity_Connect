  ...
  return (
    <div className="group/bar relative w-full bg-[#020612] border-y border-cyan-500/20 py-3 overflow-hidden select-none z-20 shadow-xl shadow-black/60">
      ...
      <div className="w-full flex items-center relative">
        ...
        <div className="flex items-center gap-2 pl-6 pr-6 py-1 border-r border-cyan-500/30 z-30 shrink-0 bg-[#020612]/95 backdrop-blur-md shadow-lg shadow-black/50">
          ...
          <span className="text-xs font-bold uppercase tracking-wider text-cyan-300 font-display flex items-center gap-1.5 whitespace-nowrap">
            <Megaphone className="w-3.5 h-3.5 text-cyan-400" /> {settings?.announcements_bar_label || 'Announcements'}
          </span>
        </div>

        {/* Gradient edge fades for seamless text entrance/exit */}
        <div className="pointer-events-none absolute left-36 sm:left-48 top-0 bottom-0 w-12 sm:w-20 bg-gradient-to-r from-[#020612] to-transparent z-20" />
        <div className="pointer-events-none absolute right-0 top-0 bottom-0 w-16 sm:w-28 bg-gradient-to-l from-[#020612] to-transparent z-20" />

        {/* Pure CSS Infinite Marquee Track (Smooth, zero-flicker instant hover pause) */}
        <div className="flex-1 overflow-hidden relative cursor-pointer">
          <div 
            ...
            style={{ animationDuration: `${settings?.announcements_bar_speed || 24}s` }}
          >
