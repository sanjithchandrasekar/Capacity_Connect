  ...
  const sidebarContent = (
    <>
      ...
      <div className="p-3 border-t border-slate-800 space-y-2">
        <div
          onClick={() => navigate(profile?.role === 'super_admin' ? '/super-admin/profile' : `/${profile?.role}/profile`)}
          className="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-slate-800/50 transition-all cursor-pointer group"
        >
