  ...
  return (
    <div className="min-h-screen bg-[#040814] text-zinc-200 font-sans relative">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <Link to="/courses" className="inline-flex items-center gap-2 text-sm text-zinc-200/60 hover:text-cyan-400 transition-colors mb-6 font-semibold">
        ...
        {isLoading ? (
          ...
          <div className="text-center p-12 bg-[#070E20]/90 border border-cyan-500/30 rounded-3xl shadow-sm">
            ...
            <p className="text-zinc-200/50 mt-2 text-sm">The course you are looking for does not exist or is not publicly available.</p>
          </div>
        ) : (
          <motion.div variants={fadeUp} initial="hidden" animate="visible" className="space-y-6">
            
            {/* Header Card */}
            <div className="bg-gradient-to-r from-purple-900 via-purple-800 to-midnight text-white border border-cyan-500/30 rounded-3xl overflow-hidden shadow-xl shadow-cyan-950/50 relative p-8 md:p-12">
              ...
              <div className="relative z-10">
                <div className="inline-block bg-[#070E20]/90/10 backdrop-blur-md px-3.5 py-1 rounded-full text-xs font-bold text-orange-300 uppercase tracking-wider border border-white/15 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="md:col-span-2 bg-[#070E20]/90 border border-cyan-500/30 rounded-3xl p-8 shadow-sm">
                <h2 className="text-lg font-bold text-zinc-200 mb-4">About this course</h2>
                <div className="text-zinc-200/70 leading-relaxed space-y-4 whitespace-pre-wrap text-sm">
              ...
              <div className="space-y-6">
                <div className="bg-[#070E20]/90 border border-cyan-500/30 rounded-3xl p-6 shadow-sm">
                  <h3 className="text-xs font-bold text-cyan-300/60 uppercase tracking-wider mb-4">Trainer Details</h3>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-200/50 font-medium">{course.trainer?.department || 'Trainer'}</p>
                    </div>
                  </div>
                </div>
              </div>
